...
public class QuickSearch implements Serializable, DataSerializable, Portable {
...
//        copy code
    ...
    public void writeData(ObjectDataOutput out) throws IOException {
        out.writeLong(locality_id);
        out.writeUTF(locality_name);
        out.writeLong(division_id);
        out.writeUTF(division_name);
        out.writeLong(brand_id);
        out.writeUTF(brand_name);
        out.writeLong(media_id);
        out.writeUTF(media_name);
        out.writeInt(media_content_approval_instruction);
        out.writeInt(media_qc_approval_instruction);
        out.writeInt(media_clock_approval_instruction);
        out.writeInt(media_class_approval_instruction);
        out.writeInt(media_instruction_approval_instruction);
        out.writeInt(media_house_nr_instruction);
        out.writeBoolean(media_music_report_required);
        out.writeInt(media_delivery_hours);
        out.writeLong(media_destination_id);
        out.writeLong(media_slave_destination_id);
        //copy_code
        out.writeLong(copy_code_id);
        out.writeLong(region_id);
        out.writeLong(media_type_media_extension_id);
        out.writeUTF(copy_code);
        out.writeBoolean(aired);
        out.writeLong(poster_id);
        out.writeInt(film_length);
        out.writeLong(first_air_date);
        out.writeInt(content_type);
        out.writeUTF(title);
        out.writeBoolean(stopped);
        out.writeBoolean(request_upload);
        out.writeLong(urr_time);
        //Sponsorship
        out.writeLong(sponsorship_locality_id);
        out.writeLong(sponsorship_division_id);
        out.writeLong(music_report_request_time);
        out.writeInt(music_report_request_count);
        out.writeInt(music_to_report);
        out.writeBoolean(music_report_completed);
        out.writeLong(music_report_completed_time);
        out.writeBoolean(music_report_completed_action);
        out.writeUTF(media_agency_planning);
        out.writeUTF(media_agency_buying);
        out.writeUTF(creative_agency);
        out.writeUTF(production_agency);
        out.writeUTF(post_production_agency);
        out.writeUTF(other_agency);
        out.writeBoolean(disabled_for_upload);
        //copy_code_media
        out.writeUTF(media_house_nr);
        out.writeUTF(b_p_code);
        out.writeBoolean(creaded_from_mismatch);
        out.writeBoolean(delivered_from_elsewhere);
        out.writeLong(media_first_air_date);
        out.writeLong(delivery_deadline);
        out.writeLong(delivery_deadline_ms_algo);
        out.writeBoolean(inactive);
        //copy_envelope
        out.writeLong(copy_envelope_id);
        out.writeInt(copy_envelope_action_state);
        out.writeLong(expiration_time);
        out.writeLong(copy_envelope_sender_id);
        out.writeLong(approval_advert_user_id);
        out.writeLong(approval_advert_time);
        out.writeInt(approval_advert_state);
        out.writeInt(quality_check_state);
        out.writeInt(proxy_creation_state);
        out.writeLong(qc_proxy_approval_time);
        out.writeBoolean(transcoding);
        //delivery
        out.writeLong(delivery_id);
        out.writeInt(delivery_action_state);
        out.writeLong(time_delivered);
        out.writeLong(slave_time_delivered);
        out.writeLong(pre_delivered_time);
        out.writeLong(slave_pre_delivered_time);
        out.writeLong(post_delivered_time);
        out.writeLong(slave_post_delivered_time);
        //content_approval
        out.writeLong(content_approval_media_user_id);
        out.writeLong(content_approval_media_time);
        out.writeInt(content_approval_media_state);
        //qc_approval
        out.writeLong(qc_approval_media_user_id);
        out.writeLong(qc_approval_media_time);
        out.writeInt(qc_approval_media_state);
        //clock_approval
        out.writeLong(clock_approval_media_user_id);
        out.writeLong(clock_approval_media_time);
        out.writeInt(clock_approval_media_state);
        //class_approval
        out.writeLong(class_approval_media_user_id);
        out.writeLong(class_approval_media_time);
        out.writeInt(class_approval_media_state);
        out.writeInt(num_instruction_approved);
        out.writeInt(num_instruction_rejected);
        out.writeInt(num_instruction_approval_not_performed);
        out.writeLong(download_speed);
        out.writeInt(mismatch);
        out.writeBoolean(mismatch_ignored);
        out.writeInt(invoice_account_demand);
    }

    @Override
    public void readData(ObjectDataInput in) throws IOException {
        locality_id = in.readLong();
        locality_name = in.readUTF();
        division_id = in.readLong();
        division_name = in.readUTF();
        brand_id = in.readLong();
        brand_name = in.readUTF();
        media_id = in.readLong();
        media_name = in.readUTF();
        media_content_approval_instruction = in.readInt();
        media_qc_approval_instruction = in.readInt();
        media_clock_approval_instruction = in.readInt();
        media_class_approval_instruction = in.readInt();
        media_instruction_approval_instruction = in.readInt();
        media_house_nr_instruction = in.readInt();
        media_music_report_required = in.readBoolean();
        media_delivery_hours = in.readInt();
        media_destination_id = in.readLong();
        media_slave_destination_id = in.readLong();
        //copy code
        copy_code_id = in.readLong();
        region_id = in.readLong();
        media_type_media_extension_id = in.readLong();
        copy_code = in.readUTF();
        aired = in.readBoolean();
        poster_id = in.readLong();
        film_length = in.readInt();
        first_air_date = in.readLong();
        content_type = in.readInt();
        title = in.readUTF();
        stopped = in.readBoolean();
        request_upload = in.readBoolean();
        urr_time = in.readLong();
        //Sponsorship
        sponsorship_locality_id = in.readLong();
        sponsorship_division_id = in.readLong();
        music_report_request_time = in.readLong();
        music_report_request_count = in.readInt();
        music_to_report = in.readInt();
        music_report_completed = in.readBoolean();
        music_report_completed_time = in.readLong();
        music_report_completed_action = in.readBoolean();
        media_agency_planning = in.readUTF();
        media_agency_buying = in.readUTF();
        creative_agency = in.readUTF();
        production_agency = in.readUTF();
        post_production_agency = in.readUTF();
        other_agency = in.readUTF();
        disabled_for_upload = in.readBoolean();
        //copy_code_media
        media_house_nr = in.readUTF();
        b_p_code = in.readUTF();
        creaded_from_mismatch = in.readBoolean();
        delivered_from_elsewhere = in.readBoolean();
        media_first_air_date = in.readLong();
        delivery_deadline = in.readLong();
        delivery_deadline_ms_algo = in.readLong();
        inactive = in.readBoolean();
        //copy_envelope
        copy_envelope_id = in.readLong();
        copy_envelope_action_state = in.readInt();
        expiration_time = in.readLong();
        copy_envelope_sender_id = in.readLong();
        approval_advert_user_id = in.readLong();
        approval_advert_time = in.readLong();
        approval_advert_state = in.readInt();
        quality_check_state = in.readInt();
        proxy_creation_state = in.readInt();
        qc_proxy_approval_time = in.readLong();
        transcoding = in.readBoolean();
        //delivery
        delivery_id = in.readLong();
        delivery_action_state = in.readInt();
        time_delivered = in.readLong();
        slave_time_delivered = in.readLong();
        pre_delivered_time = in.readLong();
        slave_pre_delivered_time = in.readLong();
        post_delivered_time = in.readLong();
        slave_post_delivered_time = in.readLong();
        //content_approval
        content_approval_media_user_id = in.readLong();
        content_approval_media_time = in.readLong();
        content_approval_media_state = in.readInt();
        //qc_approval
        qc_approval_media_user_id = in.readLong();
        qc_approval_media_time = in.readLong();
        qc_approval_media_state = in.readInt();
        //clock_approval
        clock_approval_media_user_id = in.readLong();
        clock_approval_media_time = in.readLong();
        clock_approval_media_state = in.readInt();
        //class_approval
        class_approval_media_user_id = in.readLong();
        class_approval_media_time = in.readLong();
        class_approval_media_state = in.readInt();
        num_instruction_approved = in.readInt();
        num_instruction_rejected = in.readInt();
        num_instruction_approval_not_performed = in.readInt();
        download_speed = in.readLong();
        mismatch = in.readInt();
        mismatch_ignored = in.readBoolean();
        invoice_account_demand = in.readInt();
    }
}
