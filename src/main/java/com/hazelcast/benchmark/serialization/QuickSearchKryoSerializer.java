...
public class QuickSearchKryoSerializer implements StreamSerializer<Object> {

    Kryo kryo = new Kryo();
    final boolean unsafe;

    public QuickSearchKryoSerializer(boolean unsafe) {
        this.unsafe = unsafe;
        kryo.register(QuickSearch.class);
    }
