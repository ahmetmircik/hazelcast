...
public interface AccumulatorInfoSupplier {
     ...
     * @param cacheUuid cache name.
     * @return {@link AccumulatorInfo} for cache of map.
     */
    AccumulatorInfo getAccumulatorInfoOrNull(String mapName, String cacheUuid);
     ...
     * @param cacheUuid cache name.
     */
    void putIfAbsent(String mapName, String cacheUuid, AccumulatorInfo info);
     ...
     * @param cacheUuid cache name.
     */
    void remove(String mapName, String cacheUuid);
}
