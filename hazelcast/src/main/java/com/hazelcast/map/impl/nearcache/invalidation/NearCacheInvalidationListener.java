...
public class NearCacheInvalidationListener implements InvalidationListener {

    private final InvalidationHandler handler;

    public NearCacheInvalidationListener(InvalidationHandler handler) {
    ...
    public void onInvalidate(Invalidation invalidation) {
        ...
        invalidation.consumedBy(handler);
    }
