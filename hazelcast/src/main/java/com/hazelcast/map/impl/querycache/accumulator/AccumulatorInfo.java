...
public class AccumulatorInfo implements Portable {
    ...
    public static AccumulatorInfo createAccumulatorInfo(QueryCacheConfig config, String mapName, String cacheUuid,
                                                        Predicate predicate) {
        checkNotNull(config, "config cannot be null");

        AccumulatorInfo info = new AccumulatorInfo();
        info.mapName = mapName;
        info.cacheUuid = cacheUuid;
    ...
    public static AccumulatorInfo createAccumulatorInfo(String mapName, String cacheUuid, Predicate predicate, int batchSize,
