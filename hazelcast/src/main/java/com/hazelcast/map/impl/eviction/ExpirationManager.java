...
public class ExpirationManager {
    ...
    private static final int EXPIRATION_TASK_INITIAL_DELAY_SECONDS = 5;
    ...
    private static final int MIN_DELAY_AFTER_LAST_PARTITION_CLEANUP_MILLIS = 1000;
    ...
    public void start() {
        ...
        executionService.scheduleAtFixedRate(task, EXPIRATION_TASK_INITIAL_DELAY_SECONDS, taskPeriodSeconds, SECONDS);
    }
    ...
    private class ClearExpiredRecordsTask implements Runnable {
        ...
        private boolean notInProcessableTimeWindow(PartitionContainer partitionContainer, long now) {
            return now - partitionContainer.getLastCleanupTime() < MIN_DELAY_AFTER_LAST_PARTITION_CLEANUP_MILLIS;
        }
