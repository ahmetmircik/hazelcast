...
public class MadePublishableOperation extends MapOperation {
    ...
    public MadePublishableOperation(String mapName, String cacheUuid) {
        super(mapName);
    ...
    private void setPublishable() {
        PartitionAccumulatorRegistry registry = QueryCacheUtil.getAccumulatorRegistryOrNull(getContext(), name, cacheUuid);
        if (registry == null) {
            return;
        }
