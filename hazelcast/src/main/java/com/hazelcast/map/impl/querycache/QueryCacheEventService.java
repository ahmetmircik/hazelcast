...
public interface QueryCacheEventService<E> {
     ...
     * @param cacheUuid name of the query cache
     * @param event     event to publish
     * @param orderKey  use same order key for events which are required to be ordered
     */
    void publish(String mapName, String cacheUuid, E event, int orderKey);
     ...
     */
    String listenPublisher(String mapName, String cacheUuid, ListenerAdapter listenerAdapter);
     ...
     * @return ID of registered event listener
     */
    String addListener(String mapName, String cacheUuid, MapListener listener);
     ...
     * @return ID of registered event listener
     */
    String addListener(String mapName, String cacheUuid, MapListener listener, EventFilter filter);
     ...
     */
    boolean removeListener(String mapName, String cacheUuid, String id);
     ...
     */
    boolean hasListener(String mapName, String cacheUuid);
