...
/**
 * A concurrent, queryable data structure which is used to continuously cache results of a continuous query executed
 * on an {@code IMap}. It can be also think of an always up to date materialized view of the {@code IMap}.
 * <p/>
