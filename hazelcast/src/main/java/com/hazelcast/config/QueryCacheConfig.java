...
public class QueryCacheConfig {
    ...
    /**
     * Returns the minimum number of delay millis which an event waits in the buffer of node
    ...
    public QueryCacheConfig addMapIndexConfig(MapIndexConfig mapIndexConfig) {
    ...
    public QueryCacheConfig setMapIndexConfigs(List<MapIndexConfig> mapIndexConfigs) {
