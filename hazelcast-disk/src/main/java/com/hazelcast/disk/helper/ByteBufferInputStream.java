...
//	 * @return a new read-only byte-buffer input streaam over the contents of <code>fileChannel</code>.
//	 */
...
//		for( int i = 0; i < chunks; i++ ) byteBuffer[ i ] = fileChannel.map( mapMode, i * CHUNK_SIZE,
